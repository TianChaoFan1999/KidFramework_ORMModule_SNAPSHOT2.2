...
/***
 * TODO TCF 映射器接口代理工厂类
 * TODO TCF 构造注入KidORM核心配置信息和SQL会话
 * TODO TCF 定义代理方法，基于反射调用SQL会话中的SQL执行策略实现数据持久化操作
 * @author 71485
 *
 */
	...
	public Object invoke(Object proxy, Method method, Object[] args) throws Throwable 
	{
		...
		try
		{
			...
			if(mapperBean!=null)
			{
				...
				//TODO TCF 映射器接口名必须和代理目标方法所在映射器接口名相同
